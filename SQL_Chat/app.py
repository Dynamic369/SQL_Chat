...
radio_opt = ['Use SQLite 3 Database-Student.db', 'Connect your MySQL Database']

selected_opt = st.sidebar.radio(label='Chooose the DB which you want to use',options=radio_opt)

if radio_opt.index(selected_opt)==1:
    db_uri=MYSQL
    mysql_host=st.sidebar.text_input('Please provide MYSQL host')
